...
public class BookManager {
	...
	private ConcurrentMap<String, Book> inMemoryStore = new ConcurrentHashMap<String, Book>();

	public BookManager() {
		Book book = new Book();
		book.setId(getNextId());
		book.setName("Building Microservice With Micronaut");
		book.setIsbn("1");
